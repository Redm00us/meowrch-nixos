...
### ✅ Исправленные ошибки (версия от 13.06.2025)
...
#### 🎨 Проблемы с темами
**Исправлено!** Улучшена система тематизации:
- ✅ Переписан `modules/desktop/theming.nix`
- ✅ Добавлена полная поддержка Catppuccin
- ✅ Настроены шрифты и рендеринг
...
### v2.0 - 13.06.2025 🎉
- **🔧 Исправлены критические ошибки**: Конфликт boot loader, specialArgs, темы
